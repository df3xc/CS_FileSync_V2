...

{
    ...
    public static class process_util
    {
        ...
        /// <summary>
        /// execute an application and return app output
        /// </summary>
        /// <param name="assembly_name">name of assembly</param>
        /// <param name="command_line">command line parameters</param>
        /// <returns></returns>
        ...
        public static string process_exec_wait(string assembly_name, string command_line)
        {
            int rc = 0;
            string result = "";
            ...
            try
            {
                ...
                result = theApplication.StandardOutput.ReadToEnd();
                result = result + " stderr: " + theApplication.StandardError.ReadToEnd();
                theApplication.WaitForExit();
                rc = theApplication.Id;
            }
            catch 
        ...
        /// </summary>
        /// <param name="line">the command style string</param>
        /// <returns>array of arguments </returns>
        /// <remarks>
        /// <para>example "d:\labview projects\excalibur.exe" user="donald duck" update</para>
        /// <para></para>
        /// </remarks>
    ...
    public static class logger
    {
        ...
        /// <param name="delete_old_logfile">delete existing file if true</param>
        ...
        /// </summary>
        /// <param name="AppName">will be preceeded to the text</param>
        ...
        public static void writeline(string AppName, string text)
        {
        	write(AppName,text + Environment.NewLine);
        }
        
        
 		public static void write(string AppName, string text)
        {
            DateTime time;
            time = DateTime.Now;
            string timestamp ="";
            ...
            try
            {
                if (String.IsNullOrEmpty(text) == false)
                {
                    ...
                    if (re != null)
                    {
                    	timestamp = time.ToString("MM/dd/yyyy hh:mm:ss.fff tt");   

                        Console.Write("[" + timestamp + "] " + AppName + " " + text);
                        re.Write("[" + timestamp + "] " + AppName + " " + text);
                        re.Flush();
                        re.Close();
                    }
                }
